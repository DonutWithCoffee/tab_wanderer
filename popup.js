...
const POPUP_RELEASE_NOTES = {
    version: '1.0.3',
    title: 'Что нового в 1.0.3',
    items: [
        'Успешная повторная проверка Ozon теперь сбрасывает старую ошибку и показывает актуальный результат.',
        'При частичной проверке видно, сколько штрихкодов подтверждено и сколько ещё отсутствует.',
        'Причины пропуска штрихкодов разделены: мультиштрихкоды больше не смешиваются с дублями и неполными данными.'
    ]
};
