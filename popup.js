...
const POPUP_RELEASE_NOTES = {
    version: '1.0.2',
    title: 'Что нового в 1.0.2',
    items: [
        'Статус записи штрихкодов в Ozon теперь сразу виден по тексту и цвету кнопки.',
        'Сервисные сообщения Ozon стали короче и больше не дублируются после повторной проверки.',
