...
const POPUP_RELEASE_NOTES = {
    version: '1.0.4.1',
    title: 'Исправление 1.0.4.1',
    items: [
        'Мультиштрихкоды больше не передаются в Ozon при ручной или автоматической записи.',
        'Штрихкоды с потерянным или неподтверждённым типом теперь безопасно пропускаются.',
        'Перед открытием Ozon расширение повторно проверяет весь складской список штрихкодов.'
    ]
};
